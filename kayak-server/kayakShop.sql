...
VALUES
    ...
    (uuid(), 'Type I Commercial Life Jacket', 59.99,  'KENT-Type I commercial life jacket, adult over 90lb', 'PFDs', 'KENT', 'vest', 'adults', 'orange', 'https://newcontent.westmarine.com/content/images/catalog/large/103723_LRG.14012020103004.jpg', 4.0 ),
    ...
    (uuid(), 'HeySplash Life Jacket for Kids', 25.99,  'Comes with durable heavy-duty gear zipper, double safety protection to guard your kids safety.', 'PFDs', 'HeySplash', 'vest', 'youth', 'blue', 'https://m.media-amazon.com/images/I/81cl560qAPS._AC_SX679_.jpg', 5.4),
    (uuid(), 'ONeill Child Reactor Life Jacket', 39.97,  'Comfortable enough to wear all day. Closed-cell PVC foam. Anatomical flex points increase mobility. USCG approved', 'PFDs', 'ONeill', 'vest', 'youth', 'green', 'https://www.overtons.com/dw/image/v2/BCJK_PRD/on/demandware.static/-/Sites-global-master-catalog/default/dw58c40222/images/large/300054_BKYW_1.jpg?sw=800&sh=800', 5.5),
    ...
    (uuid(), 'DSG Mens Knit Water Shoe', 24.99,  'Stretchy knit upper for breathability and comfort', 'watershoes', 'DSG', 'mens', 'adult', 'grey', 'https://images.dickssportinggoods.com/is/image/GolfGalaxy/21QYFMMNSKNTWTRSHFOT_Grey_Light_Grey?qlt=70&wid=600&fmt=webp', 5.0 ),
    (uuid(), 'Body Glove Mens 3T Cinch Water Shoes', 39.99,  'IDS (integrated drainage system) cools the foot out of the water with air circulation. Adjustable shocklace. Three-toe design', 'watershoes', 'Body Glove', 'mens', 'adult', 'black', 'https://images.dickssportinggoods.com/is/image/GolfGalaxy/17BGLM3TBRFTCNCHBFOT_Black_Black?wid=1000&fmt=pjpeg', 4.0 ),
    (uuid(), 'Body Glove Mens Vortex Water Shoes', 59.99,  'Phylon midsole. Open design to promote water drainage. Integrated Drainage System (IDS) disperses water and increases breathability. Slip-on design for easy on and off', 'watershoes', 'Body Glove', 'mens', 'adult', 'black', 'https://images.dickssportinggoods.com/is/image/GolfGalaxy/21BGLMMVRTXBLKRDXFOT_Black_Yellow?qlt=70&wid=600&fmt=webp', 4.0 ),
    (uuid(), 'DSG Direct Womens Core Water Shoes', 11.99,  'Mesh and neoprene upper for breathability and comfort.', 'watershoes', 'DSG', 'womens', 'adult', 'black', 'https://images.dickssportinggoods.com/is/image/GolfGalaxy/21QYFWWMNSCRWTRSHFOT_Black_Pink?qlt=70&wid=600&fmt=webp', 4.0 ),
    (uuid(), 'DSG Direct Womens Knit Water Shoes', 24.99,  'Stretch Knit Upper for breathability and comfort.', 'watershoes', 'DSG', 'womens', 'adult', 'black', 'https://images.dickssportinggoods.com/is/image/GolfGalaxy/21QYFWWMNSCRWTRSHFOT_Black_Pink?qlt=70&wid=600&fmt=webp', 5.0 ),
    (uuid(), 'Body Glove Womens 3T Barefoot Cinch Water Shoes', 34.99,  'Adjustable shocklace. Easy entry with the 3-toe design. Ultra-grip rubber outsole', 'watershoes', 'Body Glove', 'womens', 'adult', 'black', 'https://images.dickssportinggoods.com/is/image/GolfGalaxy/17BGLWW3TBRFTCNCHFOT_Black_Pink?qlt=70&wid=600&fmt=webp', 5.0 ),
    (uuid(), 'KEEN Kids Newport H2SHO Shoes', 64.99,  'Machine washable. Lace-lock bungee system with adjustable hook-and-loop strap. Breathable mesh lining', 'watershoes', 'KEEN', 'kids', 'kids', 'blue', 'https://images.dickssportinggoods.com/is/image/GolfGalaxy/22KEEYYNWPRTH2SHBFOT_Cobalt?qlt=70&wid=600&fmt=webp', 4.3 ),
    (uuid(), 'DSG Direct Youth Knit Water Shoes', 19.99,  'Stretch knit upper for breathability and comfort.', 'watershoes', 'DSG', 'kids', 'kids', 'yellow/black', 'https://images.dickssportinggoods.com/is/image/GolfGalaxy/21QYFYYTHKNTWTRSHFOT_Black_Volt?qlt=70&wid=600&fmt=webp', 5.0 );
